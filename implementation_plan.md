...
| Élément | Valeur |
|---|---|
| Palette | Dark deep navy `#0a0f1e` + accent cyan `#00d4ff` + violet `#7c3aed` |
| Police | Google Fonts — `Outfit` (titres) + `Inter` (corps) |
